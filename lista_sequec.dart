...
class ListaSequencial extends StatefulWidget {
  @override
  _ListaSequencialState createState() => _ListaSequencialState();
}

class _ListaSequencialState extends State<ListaSequencial> {
